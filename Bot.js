...
client.on("message", msg => {
    ...
    if(!message.toLowerCase().startsWith(prefix) || msg.author.bot == true) {
        ...
        switch(command) {
            case "aids": return aids(msg, suffix)                        
            case "help": return showCommands(msg, suffix)                        
            case "spam": return spam(msg, suffix)                        
            case "boobs":return boobs(msg, suffix)                        
            case "ass": return ass(msg, suffix)
            case "play": return play(msg, suffix)			
            case "skip": return skip(msg, suffix)
            case "queue": return queueList(msg, suffix)
...
function showCommands(msg, suffix) {
	...
	'!role [name] [role]: Sets the role of the user.\n\n' +
